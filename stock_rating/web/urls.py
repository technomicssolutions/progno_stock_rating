...
from views import Login,Logout, Dashboard, Administration, Users, SaveUser, ResetPassword, \
    ...
    ModelDetails, DeleteModel, DeleteUser, ModelView, SaveParameters, DeleteParameter, DataUpload, \
    AnalyticalHeads, SaveAnalyticalHead, DeleteHead
...
urlpatterns = patterns('',
    ...
    url(r'save_head/$', login_required(SaveAnalyticalHead.as_view()), name="save_head"),
