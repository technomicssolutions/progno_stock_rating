...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContinuityFunction.number_of_periods'
        db.delete_column(u'web_continuityfunction', 'number_of_periods')

        # Adding field 'ContinuityFunction.number_of_fields'
        db.add_column(u'web_continuityfunction', 'number_of_fields',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3),
                      keep_default=False)

        # Adding field 'ContinuityFunction.number_of_functions'
        db.add_column(u'web_continuityfunction', 'number_of_functions',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3),
                      keep_default=False)

        # Deleting field 'ConsistencyFunction.number_of_periods'
        db.delete_column(u'web_consistencyfunction', 'number_of_periods')

        # Adding field 'ConsistencyFunction.number_of_fields'
        db.add_column(u'web_consistencyfunction', 'number_of_fields',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3),
                      keep_default=False)

        # Adding field 'ConsistencyFunction.number_of_functions'
        db.add_column(u'web_consistencyfunction', 'number_of_functions',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=3),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ContinuityFunction.number_of_periods'
        raise RuntimeError("Cannot reverse this migration. 'ContinuityFunction.number_of_periods' and its values cannot be restored.")
        # Deleting field 'ContinuityFunction.number_of_fields'
        db.delete_column(u'web_continuityfunction', 'number_of_fields')

        # Deleting field 'ContinuityFunction.number_of_functions'
        db.delete_column(u'web_continuityfunction', 'number_of_functions')


        # User chose to not deal with backwards NULL issues for 'ConsistencyFunction.number_of_periods'
        raise RuntimeError("Cannot reverse this migration. 'ConsistencyFunction.number_of_periods' and its values cannot be restored.")
        # Deleting field 'ConsistencyFunction.number_of_fields'
        db.delete_column(u'web_consistencyfunction', 'number_of_fields')

        # Deleting field 'ConsistencyFunction.number_of_functions'
        db.delete_column(u'web_consistencyfunction', 'number_of_functions')
    ...
    models = {
        ...
        u'web.consistencyfunction': {
            ...
            'number_of_fields': ('django.db.models.fields.IntegerField', [], {'max_length': '3'}),
            'number_of_functions': ('django.db.models.fields.IntegerField', [], {'max_length': '3'})
        },
