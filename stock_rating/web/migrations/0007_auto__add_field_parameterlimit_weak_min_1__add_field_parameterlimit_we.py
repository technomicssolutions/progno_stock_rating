...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParameterLimit.weak_min_1'
        db.add_column(u'web_parameterlimit', 'weak_min_1',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'ParameterLimit.weak_max_1'
        db.add_column(u'web_parameterlimit', 'weak_max_1',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ParameterLimit.weak_min_1'
        db.delete_column(u'web_parameterlimit', 'weak_min_1')

        # Deleting field 'ParameterLimit.weak_max_1'
        db.delete_column(u'web_parameterlimit', 'weak_max_1')
    ...
    models = {
        ...
        u'web.parameterlimit': {
            ...
            'weak_max_1': ('django.db.models.fields.FloatField', [], {'default': '0', 'max_length': '5'}),
            'weak_min': ('django.db.models.fields.FloatField', [], {'default': '0', 'max_length': '5'}),
            'weak_min_1': ('django.db.models.fields.FloatField', [], {'default': '0', 'max_length': '5'}),
