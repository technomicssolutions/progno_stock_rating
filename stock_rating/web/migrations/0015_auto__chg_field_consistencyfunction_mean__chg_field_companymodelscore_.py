...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsistencyFunction.mean'
        db.alter_column(u'web_consistencyfunction', 'mean', self.gf('django.db.models.fields.FloatField')(max_length=5))

        # Changing field 'CompanyModelScore.score'
        db.alter_column(u'web_companymodelscore', 'score', self.gf('django.db.models.fields.FloatField')(max_length=5, null=True))
    def backwards(self, orm):

        # Changing field 'ConsistencyFunction.mean'
        db.alter_column(u'web_consistencyfunction', 'mean', self.gf('django.db.models.fields.IntegerField')(max_length=5))
    ...
    models = {
        ...
        u'web.consistencyfunction': {
            ...
            'mean': ('django.db.models.fields.FloatField', [], {'max_length': '5'}),
