...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NSEBSEPrice.last_review'
        db.add_column(u'web_nsebseprice', 'last_review',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'NSEBSEPrice.last_review'
        db.delete_column(u'web_nsebseprice', 'last_review')
