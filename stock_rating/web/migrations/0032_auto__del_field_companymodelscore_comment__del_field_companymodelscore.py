...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyModelScore.comment'
        db.delete_column(u'web_companymodelscore', 'comment')

        # Deleting field 'CompanyModelScore.star_rating'
        db.delete_column(u'web_companymodelscore', 'star_rating')

    def backwards(self, orm):
        # Adding field 'CompanyModelScore.comment'
        db.add_column(u'web_companymodelscore', 'comment',
