...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.is_all_data_available'
        db.add_column(u'web_company', 'is_all_data_available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Company.is_all_data_available'
        db.delete_column(u'web_company', 'is_all_data_available')
