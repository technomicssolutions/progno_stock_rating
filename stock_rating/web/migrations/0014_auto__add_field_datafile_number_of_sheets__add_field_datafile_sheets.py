...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataFile.number_of_sheets'
        db.add_column(u'web_datafile', 'number_of_sheets',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DataFile.sheets'
        db.add_column(u'web_datafile', 'sheets',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DataFile.number_of_sheets'
        db.delete_column(u'web_datafile', 'number_of_sheets')

        # Deleting field 'DataFile.sheets'
        db.delete_column(u'web_datafile', 'sheets')
