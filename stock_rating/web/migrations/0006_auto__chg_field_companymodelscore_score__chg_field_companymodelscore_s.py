...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyModelScore.score'
        db.alter_column(u'web_companymodelscore', 'score', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True))

        # Changing field 'CompanyModelScore.star_rating'
        db.alter_column(u'web_companymodelscore', 'star_rating_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.StarRating'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CompanyModelScore.score'
        raise RuntimeError("Cannot reverse this migration. 'CompanyModelScore.score' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CompanyModelScore.star_rating'
        raise RuntimeError("Cannot reverse this migration. 'CompanyModelScore.star_rating' and its values cannot be restored.")
    models = {
        u'auth.group': {
