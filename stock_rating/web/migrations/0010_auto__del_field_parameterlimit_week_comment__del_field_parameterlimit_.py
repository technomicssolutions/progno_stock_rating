...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParameterLimit.week_comment'
        db.delete_column(u'web_parameterlimit', 'week_comment')

        # Deleting field 'ParameterLimit.week_min'
        db.delete_column(u'web_parameterlimit', 'week_min')

        # Deleting field 'ParameterLimit.week_max'
        db.delete_column(u'web_parameterlimit', 'week_max')

        # Adding field 'ParameterLimit.strong_points'
        db.add_column(u'web_parameterlimit', 'strong_points',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'ParameterLimit.neutral_points'
        db.add_column(u'web_parameterlimit', 'neutral_points',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'ParameterLimit.weak_min'
        db.add_column(u'web_parameterlimit', 'weak_min',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'ParameterLimit.weak_max'
        db.add_column(u'web_parameterlimit', 'weak_max',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'ParameterLimit.weak_points'
        db.add_column(u'web_parameterlimit', 'weak_points',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)

        # Adding field 'ParameterLimit.weak_comment'
        db.add_column(u'web_parameterlimit', 'weak_comment',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Deleting field 'ScoreRating.week_score'
        db.delete_column(u'web_scorerating', 'week_score')

        # Adding field 'ScoreRating.weak_score'
        db.add_column(u'web_scorerating', 'weak_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ParameterLimit.week_comment'
        raise RuntimeError("Cannot reverse this migration. 'ParameterLimit.week_comment' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ParameterLimit.week_min'
        raise RuntimeError("Cannot reverse this migration. 'ParameterLimit.week_min' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ParameterLimit.week_max'
        raise RuntimeError("Cannot reverse this migration. 'ParameterLimit.week_max' and its values cannot be restored.")
        # Deleting field 'ParameterLimit.strong_points'
        db.delete_column(u'web_parameterlimit', 'strong_points')

        # Deleting field 'ParameterLimit.neutral_points'
        db.delete_column(u'web_parameterlimit', 'neutral_points')

        # Deleting field 'ParameterLimit.weak_min'
        db.delete_column(u'web_parameterlimit', 'weak_min')

        # Deleting field 'ParameterLimit.weak_max'
        db.delete_column(u'web_parameterlimit', 'weak_max')

        # Deleting field 'ParameterLimit.weak_points'
        db.delete_column(u'web_parameterlimit', 'weak_points')

        # Deleting field 'ParameterLimit.weak_comment'
        db.delete_column(u'web_parameterlimit', 'weak_comment')

        # Adding field 'ScoreRating.week_score'
        db.add_column(u'web_scorerating', 'week_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Deleting field 'ScoreRating.weak_score'
        db.delete_column(u'web_scorerating', 'weak_score')
