...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParameterLimit.analytical_head'
        db.add_column(u'web_parameterlimit', 'analytical_head',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.AnalyticalHead'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ParameterLimit.analytical_head'
        db.delete_column(u'web_parameterlimit', 'analytical_head_id')
    ...
    models = {
        ...
        u'web.parameterlimit': {
            ...
            'analysis_model': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.AnalysisModel']"}),
            'analytical_head': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.AnalyticalHead']", 'null': 'True'}),
            'function': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Function']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
