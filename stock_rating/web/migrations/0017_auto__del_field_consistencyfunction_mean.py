...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field periods on 'ContinuityFunction'
        db.delete_table('web_continuityfunction_periods')
        ...
        # Adding M2M table for field functions on 'ContinuityFunction'
        db.create_table(u'web_continuityfunction_functions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('continuityfunction', models.ForeignKey(orm[u'web.continuityfunction'], null=False)),
            ('function', models.ForeignKey(orm[u'web.function'], null=False))
        ))
        db.create_unique(u'web_continuityfunction_functions', ['continuityfunction_id', 'function_id'])

        # Deleting field 'ConsistencyFunction.mean'
        db.delete_column(u'web_consistencyfunction', 'mean')

        # Removing M2M table for field periods on 'ConsistencyFunction'
        db.delete_table('web_consistencyfunction_periods')
        ...
        # Adding M2M table for field functions on 'ConsistencyFunction'
        db.create_table(u'web_consistencyfunction_functions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('consistencyfunction', models.ForeignKey(orm[u'web.consistencyfunction'], null=False)),
            ('function', models.ForeignKey(orm[u'web.function'], null=False))
        ))
        db.create_unique(u'web_consistencyfunction_functions', ['consistencyfunction_id', 'function_id'])

    def backwards(self, orm):
        # Adding M2M table for field periods on 'ContinuityFunction'
        db.create_table(u'web_continuityfunction_periods', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('continuityfunction', models.ForeignKey(orm[u'web.continuityfunction'], null=False)),
            ('datafield', models.ForeignKey(orm[u'web.datafield'], null=False))
        ))
        db.create_unique(u'web_continuityfunction_periods', ['continuityfunction_id', 'datafield_id'])

        # Removing M2M table for field fileds on 'ContinuityFunction'
        db.delete_table('web_continuityfunction_fileds')

        # Removing M2M table for field functions on 'ContinuityFunction'
        db.delete_table('web_continuityfunction_functions')


        # User chose to not deal with backwards NULL issues for 'ConsistencyFunction.mean'
        raise RuntimeError("Cannot reverse this migration. 'ConsistencyFunction.mean' and its values cannot be restored.")
        # Adding M2M table for field periods on 'ConsistencyFunction'
        db.create_table(u'web_consistencyfunction_periods', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('consistencyfunction', models.ForeignKey(orm[u'web.consistencyfunction'], null=False)),
            ('datafield', models.ForeignKey(orm[u'web.datafield'], null=False))
        ))
        db.create_unique(u'web_consistencyfunction_periods', ['consistencyfunction_id', 'datafield_id'])

        # Removing M2M table for field fileds on 'ConsistencyFunction'
        db.delete_table('web_consistencyfunction_fileds')

        # Removing M2M table for field functions on 'ConsistencyFunction'
        db.delete_table('web_consistencyfunction_functions')
    ...
    models = {
        ...
        u'web.consistencyfunction': {
            ...
            'fileds': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['web.DataField']", 'symmetrical': 'False'}),
