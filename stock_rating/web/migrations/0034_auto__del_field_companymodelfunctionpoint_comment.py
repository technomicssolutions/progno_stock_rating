...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyModelFunctionPoint.comment'
        db.delete_column(u'web_companymodelfunctionpoint', 'comment')

    def backwards(self, orm):
        # Adding field 'CompanyModelFunctionPoint.comment'
        db.add_column(u'web_companymodelfunctionpoint', 'comment',
