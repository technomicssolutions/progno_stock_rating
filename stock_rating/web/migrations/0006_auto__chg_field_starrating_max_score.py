...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StarRating.max_score'
        db.alter_column(u'web_starrating', 'max_score', self.gf('django.db.models.fields.FloatField')(max_length=5, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'StarRating.max_score'
        raise RuntimeError("Cannot reverse this migration. 'StarRating.max_score' and its values cannot be restored.")
    models = {
        u'auth.group': {
