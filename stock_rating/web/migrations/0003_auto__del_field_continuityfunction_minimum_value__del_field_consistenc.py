...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContinuityFunction.minimum_value'
        db.delete_column(u'web_continuityfunction', 'minimum_value')

        # Deleting field 'ConsistencyFunction.minimum_value'
        db.delete_column(u'web_consistencyfunction', 'minimum_value')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ContinuityFunction.minimum_value'
        raise RuntimeError("Cannot reverse this migration. 'ContinuityFunction.minimum_value' and its values cannot be restored.")
        # Adding field 'ConsistencyFunction.minimum_value'
        db.add_column(u'web_consistencyfunction', 'minimum_value',
