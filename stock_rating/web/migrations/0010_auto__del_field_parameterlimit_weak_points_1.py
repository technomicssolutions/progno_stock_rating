...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParameterLimit.weak_points_1'
        db.delete_column(u'web_parameterlimit', 'weak_points_1')

    def backwards(self, orm):
        # Adding field 'ParameterLimit.weak_points_1'
        db.add_column(u'web_parameterlimit', 'weak_points_1',
