...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisModel.max_points'
        db.add_column(u'web_analysismodel', 'max_points',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'CompanyModelScore.points'
        db.add_column(u'web_companymodelscore', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AnalysisModel.max_points'
        db.delete_column(u'web_analysismodel', 'max_points')

        # Deleting field 'CompanyModelScore.points'
        db.delete_column(u'web_companymodelscore', 'points')
