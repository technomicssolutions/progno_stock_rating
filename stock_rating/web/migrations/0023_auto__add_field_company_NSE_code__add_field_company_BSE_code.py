...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.NSE_code'
        db.add_column(u'web_company', 'NSE_code',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.BSE_code'
        db.add_column(u'web_company', 'BSE_code',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Company.NSE_code'
        db.delete_column(u'web_company', 'NSE_code')

        # Deleting field 'Company.BSE_code'
        db.delete_column(u'web_company', 'BSE_code')
