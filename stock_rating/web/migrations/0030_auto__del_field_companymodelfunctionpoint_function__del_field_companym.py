...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyModelFunctionPoint.function'
        db.delete_column(u'web_companymodelfunctionpoint', 'function_id')

        # Deleting field 'CompanyModelFunctionPoint.model'
        db.delete_column(u'web_companymodelfunctionpoint', 'model_id')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CompanyModelFunctionPoint.function'
        raise RuntimeError("Cannot reverse this migration. 'CompanyModelFunctionPoint.function' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CompanyModelFunctionPoint.model'
        raise RuntimeError("Cannot reverse this migration. 'CompanyModelFunctionPoint.model' and its values cannot be restored.")
    models = {
        u'auth.group': {
