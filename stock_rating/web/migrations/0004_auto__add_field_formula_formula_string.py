...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Formula.formula_string'
        db.add_column(u'web_formula', 'formula_string',
                      self.gf('django.db.models.fields.CharField')(default='x*2', max_length=500),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Formula.formula_string'
        db.delete_column(u'web_formula', 'formula_string')
