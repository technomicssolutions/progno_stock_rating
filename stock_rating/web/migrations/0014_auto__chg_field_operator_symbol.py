...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Operator.symbol'
        db.alter_column(u'web_operator', 'symbol', self.gf('django.db.models.fields.CharField')(max_length=5))
    def backwards(self, orm):

        # Changing field 'Operator.symbol'
        db.alter_column(u'web_operator', 'symbol', self.gf('django.db.models.fields.CharField')(max_length=1))
    models = {
        u'auth.group': {
