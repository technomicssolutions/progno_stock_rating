...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FieldMap.data_field'
        db.alter_column(u'web_fieldmap', 'data_field_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.DataField'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FieldMap.data_field'
        raise RuntimeError("Cannot reverse this migration. 'FieldMap.data_field' and its values cannot be restored.")
    models = {
        u'auth.group': {
