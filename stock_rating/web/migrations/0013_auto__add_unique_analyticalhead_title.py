...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AnalyticalHead', fields ['title']
        db.create_unique(u'web_analyticalhead', ['title'])

    def backwards(self, orm):
        # Removing unique constraint on 'AnalyticalHead', fields ['title']
        db.delete_unique(u'web_analyticalhead', ['title'])
