...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FunctionCategory', fields ['category_name']
        db.create_unique(u'web_functioncategory', ['category_name'])

    def backwards(self, orm):
        # Removing unique constraint on 'FunctionCategory', fields ['category_name']
        db.delete_unique(u'web_functioncategory', ['category_name'])
