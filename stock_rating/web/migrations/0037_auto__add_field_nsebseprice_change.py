...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NSEBSEPrice.change'
        db.add_column(u'web_nsebseprice', 'change',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'NSEBSEPrice.change'
        db.delete_column(u'web_nsebseprice', 'change')
    ...
    models = {
        ...
        u'web.nsebseprice': {
            ...
            'change': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Company']"}),
