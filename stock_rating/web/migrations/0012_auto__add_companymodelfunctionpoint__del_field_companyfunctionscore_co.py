...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyModelFunctionPoint'
        db.create_table(u'web_companymodelfunctionpoint', (
        ...
        db.send_create_signal(u'web', ['CompanyModelFunctionPoint'])

        # Deleting field 'CompanyFunctionScore.comment'
        db.delete_column(u'web_companyfunctionscore', 'comment')

        # Deleting field 'CompanyFunctionScore.points'
        db.delete_column(u'web_companyfunctionscore', 'points')

    def backwards(self, orm):
        # Deleting model 'CompanyModelFunctionPoint'
        db.delete_table(u'web_companymodelfunctionpoint')

        # Adding field 'CompanyFunctionScore.comment'
        db.add_column(u'web_companyfunctionscore', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyFunctionScore.points'
        db.add_column(u'web_companyfunctionscore', 'points',
                      self.gf('django.db.models.fields.FloatField')(max_length=5, null=True, blank=True),
                      keep_default=False)
