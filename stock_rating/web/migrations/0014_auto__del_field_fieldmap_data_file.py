...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FieldMap.data_file'
        db.delete_column(u'web_fieldmap', 'data_file_id')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FieldMap.data_file'
        raise RuntimeError("Cannot reverse this migration. 'FieldMap.data_file' and its values cannot be restored.")
    models = {
        u'auth.group': {
