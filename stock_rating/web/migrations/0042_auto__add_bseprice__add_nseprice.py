...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BSEPrice'
        db.create_table(u'web_bseprice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Company'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('BSE_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5, blank=True)),
        ))
        db.send_create_signal(u'web', ['BSEPrice'])

        # Adding model 'NSEPrice'
        db.create_table(u'web_nseprice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Company'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('NSE_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5, blank=True)),
        ))
        db.send_create_signal(u'web', ['NSEPrice'])

    def backwards(self, orm):
        # Deleting model 'BSEPrice'
        db.delete_table(u'web_bseprice')

        # Deleting model 'NSEPrice'
        db.delete_table(u'web_nseprice')
    ...
    models = {
        ...
        u'web.bseprice': {
            'BSE_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'}),
            'Meta': {'object_name': 'BSEPrice'},
        ...
        u'web.company': {
            ...
            'bse_scrip_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'unavailable_data': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'})
        },
        u'web.companyfile': {
        ...
        u'web.companymodelfunctionpoint': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Company']"}),
            u'date_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['web.Date']", 'unique': 'True', 'primary_key': 'True'}),
            'parameter_limit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.ParameterLimit']", 'null': 'True', 'blank': 'True'}),
        ...
        u'web.companymodelscore': {
            ...
            'score': ('django.db.models.fields.FloatField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            'star_rating': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.StarRating']", 'null': 'True', 'blank': 'True'}),
            'star_rating_change': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'web.consistencyfunction': {
            ...
            'fields': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'fields_in_consistency'", 'symmetrical': 'False', 'to': u"orm['web.DataField']"}),
        ...
        u'web.continuityfunction': {
            ...
            'fields': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'fields_in_continuity'", 'symmetrical': 'False', 'to': u"orm['web.DataField']"}),
            u'function_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['web.Function']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'web.nseprice': {
            'Meta': {'object_name': 'NSEPrice'},
            'NSE_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Company']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
