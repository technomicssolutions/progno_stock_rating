...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AnalysisModel.name'
        db.delete_column(u'web_analysismodel', 'name')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AnalysisModel.name'
        raise RuntimeError("Cannot reverse this migration. 'AnalysisModel.name' and its values cannot be restored.")
    models = {
        u'auth.group': {
