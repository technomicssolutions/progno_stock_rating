...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyModelScore.star_rating_change'
        db.add_column(u'web_companymodelscore', 'star_rating_change',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CompanyModelScore.star_rating_change'
        db.delete_column(u'web_companymodelscore', 'star_rating_change')
