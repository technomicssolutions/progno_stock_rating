...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyFunctionScore.score'
        db.alter_column(u'web_companyfunctionscore', 'score', self.gf('django.db.models.fields.FloatField')(max_length=5, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CompanyFunctionScore.score'
        raise RuntimeError("Cannot reverse this migration. 'CompanyFunctionScore.score' and its values cannot be restored.")
    models = {
        u'auth.group': {
