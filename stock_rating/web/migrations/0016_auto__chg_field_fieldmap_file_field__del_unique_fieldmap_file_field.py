...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'FieldMap', fields ['file_field']
        db.delete_unique(u'web_fieldmap', ['file_field'])


        # Changing field 'FieldMap.file_field'
        db.alter_column(u'web_fieldmap', 'file_field', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FieldMap.file_field'
        raise RuntimeError("Cannot reverse this migration. 'FieldMap.file_field' and its values cannot be restored.")
        # Adding unique constraint on 'FieldMap', fields ['file_field']
        db.create_unique(u'web_fieldmap', ['file_field'])
