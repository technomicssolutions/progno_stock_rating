...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NSEBSEPrice.parent'
        db.add_column(u'web_nsebseprice', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.NSEBSEPrice'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'NSEBSEPrice.parent'
        db.delete_column(u'web_nsebseprice', 'parent_id')
