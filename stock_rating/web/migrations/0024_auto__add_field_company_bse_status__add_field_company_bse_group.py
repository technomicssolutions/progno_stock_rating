...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.bse_status'
        db.add_column(u'web_company', 'bse_status',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.bse_group'
        db.add_column(u'web_company', 'bse_group',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Company.bse_status'
        db.delete_column(u'web_company', 'bse_status')

        # Deleting field 'Company.bse_group'
        db.delete_column(u'web_company', 'bse_group')
