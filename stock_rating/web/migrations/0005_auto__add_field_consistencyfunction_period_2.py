...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsistencyFunction.period_2'
        db.add_column(u'web_consistencyfunction', 'period_2',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=5),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ConsistencyFunction.period_2'
        db.delete_column(u'web_consistencyfunction', 'period_2')
