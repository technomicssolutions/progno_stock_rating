...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Function', fields ['function_name']
        db.create_unique(u'web_function', ['function_name'])

    def backwards(self, orm):
        # Removing unique constraint on 'Function', fields ['function_name']
        db.delete_unique(u'web_function', ['function_name'])
