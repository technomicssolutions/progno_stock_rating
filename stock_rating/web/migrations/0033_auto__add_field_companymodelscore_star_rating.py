...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyModelScore.star_rating'
        db.add_column(u'web_companymodelscore', 'star_rating',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.StarRating'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CompanyModelScore.star_rating'
        db.delete_column(u'web_companymodelscore', 'star_rating_id')
