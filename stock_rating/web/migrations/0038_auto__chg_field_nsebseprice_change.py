...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NSEBSEPrice.change'
        db.alter_column(u'web_nsebseprice', 'change', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    def backwards(self, orm):

        # Changing field 'NSEBSEPrice.change'
        db.alter_column(u'web_nsebseprice', 'change', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5))
    models = {
        u'auth.group': {
        ...
        u'web.nsebseprice': {
            ...
            'Meta': {'object_name': 'NSEBSEPrice'},
            'NSE_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'}),
            'change': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Company']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_review': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'latest': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.NSEBSEPrice']", 'null': 'True', 'blank': 'True'})
        },
        u'web.operator': {
