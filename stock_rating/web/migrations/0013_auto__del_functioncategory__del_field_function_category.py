...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Function.category'
        db.delete_column(u'web_function', 'category_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'web_functioncategory', (
            ...
            ('category_name', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True)),
        ))
        db.send_create_signal(u'web', ['FunctionCategory'])


        # User chose to not deal with backwards NULL issues for 'Function.category'
        raise RuntimeError("Cannot reverse this migration. 'Function.category' and its values cannot be restored.")
    models = {
        u'auth.group': {
