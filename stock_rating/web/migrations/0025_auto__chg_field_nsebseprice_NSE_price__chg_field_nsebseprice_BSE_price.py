...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NSEBSEPrice.NSE_price'
        db.alter_column(u'web_nsebseprice', 'NSE_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5))

        # Changing field 'NSEBSEPrice.BSE_price'
        db.alter_column(u'web_nsebseprice', 'BSE_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'NSEBSEPrice.NSE_price'
        raise RuntimeError("Cannot reverse this migration. 'NSEBSEPrice.NSE_price' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'NSEBSEPrice.BSE_price'
        raise RuntimeError("Cannot reverse this migration. 'NSEBSEPrice.BSE_price' and its values cannot be restored.")
    models = {
        u'auth.group': {
