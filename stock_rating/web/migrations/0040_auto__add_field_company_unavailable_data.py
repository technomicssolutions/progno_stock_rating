...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.unavailable_data'
        db.add_column(u'web_company', 'unavailable_data',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Company.unavailable_data'
        db.delete_column(u'web_company', 'unavailable_data')
