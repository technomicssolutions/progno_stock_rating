...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'NSEBSEPrice'
        db.delete_table(u'web_nsebseprice')

    def backwards(self, orm):
        # Adding model 'NSEBSEPrice'
        db.create_table(u'web_nsebseprice', (
            ('last_review', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('NSE_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.NSEBSEPrice'], null=True, blank=True)),
        ...
        db.send_create_signal(u'web', ['NSEBSEPrice'])
