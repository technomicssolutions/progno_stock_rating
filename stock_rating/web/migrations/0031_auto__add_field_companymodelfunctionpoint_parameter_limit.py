...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyModelFunctionPoint.parameter_limit'
        db.add_column(u'web_companymodelfunctionpoint', 'parameter_limit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.ParameterLimit'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CompanyModelFunctionPoint.parameter_limit'
        db.delete_column(u'web_companymodelfunctionpoint', 'parameter_limit_id')
