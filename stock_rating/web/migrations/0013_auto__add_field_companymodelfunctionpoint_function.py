...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyModelFunctionPoint.function'
        db.add_column(u'web_companymodelfunctionpoint', 'function',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['web.Function']),
                      keep_default=False)
