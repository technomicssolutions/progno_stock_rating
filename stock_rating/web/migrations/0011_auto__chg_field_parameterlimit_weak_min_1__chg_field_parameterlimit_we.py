...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParameterLimit.weak_min_1'
        db.alter_column(u'web_parameterlimit', 'weak_min_1', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'ParameterLimit.weak_min'
        db.alter_column(u'web_parameterlimit', 'weak_min', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ParameterLimit.strong_max'
        db.alter_column(u'web_parameterlimit', 'strong_max', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ParameterLimit.weak_max'
        db.alter_column(u'web_parameterlimit', 'weak_max', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ParameterLimit.weak_max_1'
        db.alter_column(u'web_parameterlimit', 'weak_max_1', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    def backwards(self, orm):

        # Changing field 'ParameterLimit.weak_min_1'
        db.alter_column(u'web_parameterlimit', 'weak_min_1', self.gf('django.db.models.fields.FloatField')(max_length=5, null=True))

        # Changing field 'ParameterLimit.weak_min'
        db.alter_column(u'web_parameterlimit', 'weak_min', self.gf('django.db.models.fields.FloatField')(max_length=5))

        # Changing field 'ParameterLimit.strong_max'
        db.alter_column(u'web_parameterlimit', 'strong_max', self.gf('django.db.models.fields.FloatField')(max_length=5))

        # Changing field 'ParameterLimit.weak_max'
        db.alter_column(u'web_parameterlimit', 'weak_max', self.gf('django.db.models.fields.FloatField')(max_length=5))

        # Changing field 'ParameterLimit.weak_max_1'
        db.alter_column(u'web_parameterlimit', 'weak_max_1', self.gf('django.db.models.fields.FloatField')(max_length=5, null=True))
    models = {
        u'auth.group': {
        ...
        u'web.consistencyfunction': {
            ...
            'periods': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['web.DataField']", 'symmetrical': 'False'})
        },
