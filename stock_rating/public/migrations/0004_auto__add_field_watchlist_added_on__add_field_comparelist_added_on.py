...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WatchList.added_on'
        db.add_column(u'public_watchlist', 'added_on',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompareList.added_on'
        db.add_column(u'public_comparelist', 'added_on',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'WatchList.added_on'
        db.delete_column(u'public_watchlist', 'added_on')

        # Deleting field 'CompareList.added_on'
        db.delete_column(u'public_comparelist', 'added_on')
