...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WatchList.company'
        db.add_column(u'public_watchlist', 'company',
        ...
        # Adding field 'CompareList.company'
        db.add_column(u'public_comparelist', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Company'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WatchList.company'
        db.delete_column(u'public_watchlist', 'company_id')
        ...
        # Deleting field 'CompareList.company'
        db.delete_column(u'public_comparelist', 'company_id')
