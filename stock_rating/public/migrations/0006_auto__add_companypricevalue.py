...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyPriceValue'
        db.create_table(u'public_companypricevalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Company'], null=True, blank=True)),
            ('bse_price', self.gf('django.db.models.fields.FloatField')(max_length=10, null=True, blank=True)),
            ('nse_price', self.gf('django.db.models.fields.FloatField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'public', ['CompanyPriceValue'])

    def backwards(self, orm):
        # Deleting model 'CompanyPriceValue'
        db.delete_table(u'public_companypricevalue')
