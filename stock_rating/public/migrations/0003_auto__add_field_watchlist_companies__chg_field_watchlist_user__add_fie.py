...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WatchList.companies'
        db.add_column(u'public_watchlist', 'companies',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Company'], null=True, blank=True),
                      keep_default=False)
        ...
        # Changing field 'WatchList.user'
        db.alter_column(u'public_watchlist', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['public.PublicUser'], null=True))
        # Adding field 'CompareList.companies'
        db.add_column(u'public_comparelist', 'companies',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Company'], null=True, blank=True),
                      keep_default=False)
        ...
        # Changing field 'CompareList.user'
        db.alter_column(u'public_comparelist', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['public.PublicUser'], null=True))
    def backwards(self, orm):
        # Deleting field 'WatchList.companies'
        db.delete_column(u'public_watchlist', 'companies_id')
        ...
        # User chose to not deal with backwards NULL issues for 'WatchList.user'
        raise RuntimeError("Cannot reverse this migration. 'WatchList.user' and its values cannot be restored.")
        # Deleting field 'CompareList.companies'
        db.delete_column(u'public_comparelist', 'companies_id')
        ...
        # User chose to not deal with backwards NULL issues for 'CompareList.user'
        raise RuntimeError("Cannot reverse this migration. 'CompareList.user' and its values cannot be restored.")
    models = {
        u'auth.group': {
        ...
        u'public.comparelist': {
            ...
            'companies': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Company']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
